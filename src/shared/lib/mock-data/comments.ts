...
export const mockComments: IComment[] = [
  ...
  // Technical Considerations - Resolved
  {
    ...
    specDocumentId: 'spec-4',
    section: 'technical',
    content: 'Should we implement debouncing for the filter inputs to reduce API calls?',
    authorId: 'user-2',
    resolved: false,
  ...
  // Edge Cases - Resolved
  {
    ...
    specDocumentId: 'spec-4',
    section: 'edge-cases',
    content: 'What happens if a tag is deleted while a user has it selected as a filter?',
    authorId: 'user-2',
    resolved: false,
  ...
  // Edge Cases - Resolved
  {
    ...
    specDocumentId: 'spec-4',
    section: 'edge-cases',
    content: 'How do we handle very large numbers of tags in the filter dropdown?',
    authorId: 'user-4',
    resolved: false,
  ...
  },
  {
    ...
    specDocumentId: 'spec-4',
    section: 'assumptions',
    content: 'Maximum 1000 results per page even with filters. Should be plenty for most use cases.',
    authorId: 'user-1',
