    ...
    <span
      className={cn(
        'inline-flex items-center rounded-full font-medium',
        {
          ...
          'bg-purple-100 text-purple-800 dark:bg-purple-900/50 dark:text-purple-300': variant === 'primary',
          ...
          'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300': variant === 'blue',
          'bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300':
            variant === 'purple',
          'bg-cyan-100 text-cyan-700 dark:bg-cyan-900 dark:text-cyan-300': variant === 'cyan',
          'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300': variant === 'green',
